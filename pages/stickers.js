      ...
      <section className="text-gray-600 body-font">
        ...
        <div className="container px-5 py-14 mx-auto">
          <div className="flex flex-wrap -m-4 justify-center">
            {Object.keys(products).length===0 && <p>Sorry all the stickers are currently out of stocks.New stock coming soon. Stay tuned</p>}
            {Object.keys(products).map((item) => {
              return <Link key={products[item].slug} passHref href={`/product/${products[item].slug}`}><div className="lg:w-1/5 cursor-pointer shadow-lg m-5 md:w-1/2 p-4 w-full">
